...
DATA_DIR1 = "/Users/tschmidt/repos/tgs_honours/good_data/16-ch2-apr24/" # This one needs trailing / for goes lib
...
GOES.download('goes16', 'ABI-L1b-RadF', Channel = ['02'],
              DateTimeIni = '20190424-162000', DateTimeFin = '20190425-010000',
              Rename_fmt = '%Y%m%d%H%M', PathOut = DATA_DIR1)
